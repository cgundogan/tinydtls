...
int dtls_ec_make_key(uint8_t p_publicKey[], uint8_t p_privateKey[], dtls_ec_curve curve)
{
...
int dtls_ec_shared_secret(const uint8_t p_publicKey[], const uint8_t p_privateKey[], uint8_t p_secret[], dtls_ec_curve p_curve)
{
    // Check for a valid function pointer
...
int dtls_ec_sign(const uint8_t p_privateKey[], const uint8_t p_hash[],
             unsigned p_hash_size, uint8_t *p_signature, dtls_ec_curve p_curve)
{
    // Check for a valid function pointer
    if (g_sign_cb != NULL)
    {
...
int dtls_ec_verify(const uint8_t p_publicKey[], const uint8_t p_hash[],
                   unsigned p_hash_size, const uint8_t *p_signature, dtls_ec_curve p_curve)
{
	// Check for a valid function pointer
	if (g_verify_cb != NULL)
	{
