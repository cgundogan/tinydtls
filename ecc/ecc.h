...
*/
typedef int (*dtls_ec_make_key_Function)(uint8_t p_publicKey[], uint8_t p_privateKeyHandle[], uECC_Curve curve);
...
* @return 1 upon success, 0 if an error occurred.
*/
typedef int (*dtls_ec_sign_Function)(uint8_t p_privateKeyHandle[], const uint8_t p_hash[], unsigned p_hash_size, uint8_t p_signature[], uECC_Curve p_curve);
...
* @return 1 upon success, 0 if an error occurred.
*/
typedef int (*dtls_ec_verify_Function)(const uint8_t p_publicKey[], const uint8_t p_hash[], unsigned p_hash_size, const uint8_t *p_signature, uECC_Curve p_curve);
...
* @return 1 upon success, 0 if an error occurred.
*/
typedef int (*dtls_ec_shared_secret_Function)(const uint8_t p_publicKey[], const uint8_t p_privateKeyHandle[], uint8_t p_secret[], uECC_Curve curve);
 ...
 * @return
 */
int dtls_ec_make_key(uint8_t p_publicKey[], uint8_t p_privateKey[], uECC_Curve p_curve);
 ...
 * @return
 */
int dtls_ec_shared_secret(const uint8_t p_publicKey[], const uint8_t p_privateKey[], uint8_t p_secret[], uECC_Curve curve);
 ...
 * @return
 */
int dtls_ec_sign(const uint8_t p_privateKey[], const uint8_t p_hash[], unsigned p_hash_size, uint8_t *p_signature, uECC_Curve p_curve);
 ...
 * @return
 */
int dtls_ec_verify(const uint8_t p_publicKey[], const uint8_t p_hash[], unsigned p_hash_size, const uint8_t *p_signature, uECC_Curve p_curve);
